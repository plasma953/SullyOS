            ...
            <div className="epub-r h-full w-full flex flex-col relative overflow-hidden font-sans animate-fade-soft" data-theme={readerTheme} style={{ background: 'var(--er-bg)' }}>
                ...
                <div className="absolute top-0 w-full px-4 pb-4 flex justify-between z-30 pointer-events-none" style={{ paddingTop: 'max(1rem, var(--safe-top))' }}>
                    ...
                    <div className="flex items-center gap-1.5 pointer-events-auto">
                        <button onClick={() => {  setShowThemeMenu(true); }} className="epub-r-glass p-2 rounded-full backdrop-blur-md transition-colors" title="阅读配色">
                            <Palette size={14} />
                        </button>
                        <div onClick={() => {  setShowChapterMenu(true); }} className="epub-r-glass px-4 py-1.5 rounded-full backdrop-blur-md text-xs font-bold shadow-sm cursor-pointer flex items-center gap-2">
                ...
                <div ref={readerBarRef} className="epub-r-controls absolute bottom-0 w-full backdrop-blur-xl border-t p-4 z-30 pb-safe">
                    <div className="flex gap-2">
                        ...
                        <button
                            onClick={() => {  setMode('classroom'); handleTeach(activeCourse, readerIdx); }}
