...
// 「语音演出规范」原文已迁入提示词目录（utils/promptPresetCatalog，Preset App
// 可编辑/启停/恢复默认）。这里保留旧导出名作别名，指向目录登记的内置默认正文。
import { getBuiltinContent } from './promptPresetCatalog';
export const VOICE_ACTING_GUIDE = getBuiltinContent('voice.minimax');
