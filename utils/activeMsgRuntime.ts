...
const flushInboxToChatImpl = async (trigger: FlushTrigger = '上线补收'): Promise<string[]> => {
 ...
 */
export const flushInboxToChat = (trigger: FlushTrigger = '上线补收'): Promise<string[]> => {
